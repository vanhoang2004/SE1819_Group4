...
public class TeacherController {
    ...
    StudentTakenPraticeRepository stpr;
...
//    }
    ...
    @GetMapping("/practicescore/{classcode}/{mocktestid}")
    public String getPracticeScore(Model model, @PathVariable int classcode, @PathVariable int mocktestid) throws IOException {
